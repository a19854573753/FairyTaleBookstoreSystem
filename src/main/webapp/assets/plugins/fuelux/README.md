...
[![Fuel UX](https://s3.amazonaws.com/fuelux/logo-gray.png)](exacttarget.github.com/fuelux)
...
[![Build Status](https://secure.travis-ci.org/ExactTarget/fuelux.png?branch=master)](travis-ci.org/ExactTarget/fuelux)

# Features

Fuel UX provides all of the styles and plugins from the revolutionary [Twitter Bootstrap](twitter.github.com/bootstrap) project, with the following additions:

* Fuel UX JavaScript controls (with unit tests) [see them live](exacttarget.github.com/fuelux)
...
* [AMD](requirejs.org/docs/whyamd.html) compatibility for modular structure and deployment optimization
...
Hosted on GitHub pages: exacttarget.github.com/fuelux

### Rich documentation

Hosted on our [Developer Community](code.exacttarget.com/devcenter/home): code.exacttarget.com/devcenter/fuel-ux
...
_Fuel UX is semantically versioned: <semver.org>_
...
* [jQuery](jquery.com) (Library for DOM, events, animation, and AJAX)

* [Twitter Bootstrap](twitter.github.com/bootstrap) (Modern UI components and interactions)

* [LESS](lesscss.org) and [recess](twitter.github.com/recess) (Stylesheet definition and management)

* [RequireJS](requirejs.org) and [volo](https://github.com/volojs/volo) (Tools for managing modular JavaScript)
...
+ github.com/bkohlmeier

**Kevin Parkerson**

+ github.com/kevinparkerson

**Christopher McCulloh**

+ github.com/cmcculloh
...
+ twitter.com/djmccormick
+ github.com/djmccormick

**Scott Plumlee**

+ twitter.com/scottplumlee
+ github.com/plumlee

**Marvin Pribble**

+ github.com/marvinpribble
...
[![githalytics.com alpha](https://cruel-carlota.pagodabox.com/8b519d39e18063752f24876583a6526b "githalytics.com")](githalytics.com/ExactTarget/fuelux)
