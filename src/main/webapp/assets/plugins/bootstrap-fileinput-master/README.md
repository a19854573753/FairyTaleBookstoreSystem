...
[![Bower version](https://badge.fury.io/bo/bootstrap-fileinput.svg)](badge.fury.io/bo/bootstrap-fileinput)
...
> NOTE: An alternative new [Krajee Explorer Theme](plugins.krajee.com/file-krajee-explorer-demo) (preview shown below) for `bootstrap-fileinput` has been released and available since v4.3.7. For more theming options and suggestions refer the [theming demos](plugins.krajee.com/file-theme-demo).
...
View the [plugin documentation](plugins.krajee.com/file-input) and [plugin demos](plugins.krajee.com/file-input/demo) at Krajee JQuery plugins. 

# Pre-requisites  

1. [Bootstrap 3.x](getbootstrap.com/)
2. Latest [JQuery](jquery.com/)
