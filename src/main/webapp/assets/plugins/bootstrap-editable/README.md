...
# Live demo
**vitalets.github.io/x-editable/demo.html**

# Installation

### Manual download
Use **vitalets.github.io/x-editable**
...
## Reporting issues
When creating issues please provide [jsFiddle](jsfiddle.net) example. You can easily fork one of following:   
1. [jsFiddle bootstrap template](jsfiddle.net/xBB5x/1817)  
2. [jsFiddle jqueryui template](jsfiddle.net/xBB5x/196)  
3. [jsFiddle jquery template](jsfiddle.net/xBB5x/197)    
