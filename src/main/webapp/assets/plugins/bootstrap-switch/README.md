...
Demo
----
Hurray! www.larentis.eu/switch/ moves to github pages and we are happy to tell you that we have bought a new domain: www.bootstrap-switch.org . Some troubles can occur so please, don't hate us :')
...
<script src="cdnjs.cloudflare.com/ajax/libs/bootstrap-switch/1.7/bootstrap-switch.min.js">  // from cdnjs.com
```
