...
**[View a demo](www.dangrossman.info/2012/08/20/a-date-range-picker-for-twitter-bootstrap/)**

# Usage

This component relies on [Twitter Bootstrap](twitter.github.com/bootstrap/), 
[Moment.js](momentjs.com/) and [jQuery](jquery.com/).
