...
[View Demo](xoxco.com/projects/code/tagsinput/)

[Test it yourself using this jsFiddle Demo](jsfiddle.net/7aDak/)

Created by [XOXCO](xoxco.com)
...
autocomplete url.
	...
	$('#tags').tagsInput({
	  autocomplete_url:'myserver.com/api/autocomplete'
	});
