...
<!--
For full documentation and examples, please visit [Bootstrap Date Paginator Website](www.jonathandanielmiles.com/bootstrap-datepaginator/ "Click to visit Bootstrap Date Paginator")
-->

# Requirements

- [Bootstrap v3.0.0](getbootstrap.com/)
- [jQuery v1.8.2](jquery.com/)
- [Moment.js v2.1.0](momentjs.com)
